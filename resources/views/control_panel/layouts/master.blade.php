...
<body class="hold-transition skin-black sidebar-mini fixed skin-red">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><img src="{{ asset('/img/unc-logo.png') }}" style="height: 35px;"></span>
        ...
        @if (Auth::user()->role == 1 || Auth::user()->role == 0)
          <li class="treeview">
              <a href="#">
                ...
                <span>Maintenance</span>
                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i><span class="label label-primary pull-right">8</span></span>
              </a>
              <ul class="treeview-menu">
                  {{--  Admin Menu  --}}
                  ...
                  <li><a href="{{ route('admin.maintenance.student_category') }}"><i class="fa fa-circle-o"></i>&nbsp;&nbsp;&nbsp; <span>Student Category</span></a></li>
                  {{--  Admin Menu End  --}}
