...
Route::group(['prefix' => 'finance', 'middleware' => ['auth', 'userroles'], 'roles' => ['finance']], function () {
    ...
    Route::group(['prefix' => 'student-information'], function (){
        ...
        Route::get('print-enrollment-bill', 'Finance\StudentController@print_enrollm
        
        ent_bill')->name('finance.print_enrollment_bill');
...
>>>>>>> 66df5b190ed2db7fe83a1063a85242a9157a0650
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'userroles'], 'roles' => ['admin', 'root']], function() {
    ...
    Route::group(['prefix' => 'maintenance'], function() {
        ...
        Route::group(['prefix' => 'student-category'], function () {
            Route::get('', 'Control_Panel\Maintenance\StudentCategoryController@index')->name('admin.maintenance.student_category');
            Route::post('', 'Control_Panel\Maintenance\StudentCategoryController@index')->name('admin.maintenance.student_category');
            Route::post('modal-data', 'Control_Panel\Maintenance\StudentCategoryController@modal_data')->name('admin.maintenance.student_category.modal_data');
            Route::post('save-data', 'Control_Panel\Maintenance\StudentCategoryController@save_data')->name('admin.maintenance.student_category.save_data');
            Route::post('deactivate-data', 'Control_Panel\Maintenance\StudentCategoryController@deactivate_data')->name('admin.maintenance.student_category.deactivate_data');
        });
    });
