    ...
    public function index (Request $request)
    {
        ...
        if ($StudentInformation) 
        {
            ...
            // firstsem
                ...
                // ->select(\DB::raw("
                //     enrollments.id as enrollment_id,
                //     enrollments.class_details_id as c_id,
                //     class_details.grade_level,
                //     class_details.school_year_id,                    
                //     CONCAT(faculty_informations.last_name, ', ', faculty_informations.first_name, ' ', faculty_informations.middle_name) as faculty_name,
                //     subject_details.id as subject_id,
                ...
                $grade_level = 1;
                    ...
                    //     $subject_id =  $Enrollment[0]->subject_id;
                    //     // $grade = $StudentEnrolledSubject->firstWhere('subject_id', $Enrollment[0]->subject_id);  
        ...
        //   2ndsem
            ...
            return view('control_panel_student.grade_sheet.index', compact('StudentEnrolledSubject2','StudentEnrolledSubject','GradeSheetData', 'grade_level' ,'StudentInformation','GradeSheetData1','getSchoolYear','Enrollment2','Enrollment'));
